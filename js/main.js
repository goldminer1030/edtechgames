...
$(document).ready(function () {
  ...
  var myFullpage = new fullpage('#fullpage', {
    ...
    onLeave: function (origin, destination, direction) {
      ...
      var header_height = $(window).width() >= 768 ? 66 : 51;
      ...
      if (origin && destination) {
        if (destination.index < origin.index) {
          ...
          if (destination.index == 4) {
            ...
            $('#section' + destination.index + ' .parts-all').css("margin-top", isMobile ? header_height * 2 : header_height + "px");
          }
        } else {
          // scroll down
          if (destination.index == 4) {
...
$(window).resize(function () {
  ...
  if ($(window).width() >= 768) {
    $('#section0').css("background-image", "none");
    $('.grid-container').css("margin-top", "66px");
  } else {
    $('.grid-container').css("margin-top", "51px");
  }
