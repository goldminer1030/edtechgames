    ...
    <div id="fullpage">
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <img src="images/vertbkgd01.png" alt="carousel">
                </div>
                <div class="item">
                  <img src="images/vertbkgd02.png" alt="carousel">
                </div>
                <div class="item">
                  <img src="images/vertbkgd03.png" alt="carousel">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-7 col-sm-6 sub-details right-side">
              ...
              <div class="sub-detail-screenshots">
                <div class="row">
                  ...
                  <div class="col-xs-6 sc-wrapper">
                    <a class="screenshot" href="images/Unit_1.0_hd.png" data-fluidbox="true">
                      <img src="images/Unit_1.0_sm.png" alt="screenshot">
                    </a>
                  </div>
                </div>
              </div>
      ...
      <div class="section info-section" id="section2">
        <section class="parts-all mydiv" id="part_two">
          <h1><strong>Intense</strong> Engagement = <strong>Intense</strong> Learning</h1>
          <div class="row">
