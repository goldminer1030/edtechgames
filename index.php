...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <meta name="author" content="EDTECH GAMES, LLC">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="Keywords" content="EDTECH GAMES">

    <title>Edtech-Games</title>
  ...
  <body onresize='document.getElementsByTagName("body")[0].style[ "font-size" ] = document.body.clientWidth*(12/1280) + "px";'>
    <header id="header-main">
      <nav class="navbar navbar-default navbar-fixed-top scroll-old">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand hidden-sm hidden-md hidden-lg" href="#"><img src="images/logo-edtech.png" alt="Brand" width="180" /></a>
          </div>
    ...
    <div id="fullpage">
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <img src="images/boybot1v.png" alt="carousel">
                </div>
                <div class="item">
                  <img src="images/new.png" alt="carousel">
                </div>
                <div class="item">
                  <img src="images/unit2v.png" alt="carousel">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="section" id="section4">
        <section class="parts-all mydiv" id="part_four">
          ...
          <a class="brick brick--width2" href="images/customcharacter1_new.png" data-fluidbox="true">
          ...
          <a class="brick brick--width2" href="images/story1_new_new.png" data-fluidbox="true">
          ...
          <a class="brick brick--width2" href="images/grodpole1_new.png" data-fluidbox="true">
            <img src="images/grodpole1_new.png" alt="screenshot">
          </a>
          <a class="brick" href="images/shrine1c2_new.png" data-fluidbox="true">
            <img src="images/shrine1c2_new.png" alt="screenshot">
      ...
      <div class="section contact-main" id="section5">
        <section class="parts-all mydiv" id="part_five" >
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-8 col-md-8 col-sm-6 hidden-xs dino-top">
                <img class="dino-img" src="images/DinoBanner_Rex.png" alt="">
              </div>
              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-top">
                <div class="form-wrapper">
                  ...
                  <form id="contact_form" name="myForm" action="/sendinblue_email.php" method="POST">
                    ...
                    <div class="form-group">
                      <input type="email" name="vemail" class="form-control" id="email" placeholder="Enter Email">
                      <span class="form-error" id="vemail-error"></span>
                    </div>
                    <div class="form-group">
                      <input type="email" name="vre_email" class="form-control" id="remail" placeholder="Confirm Email">
                      <span class="form-error" id="vre_email-error"></span>
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript" src="vendor/freewall/freewall.js"></script>
